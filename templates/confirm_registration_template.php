<?php
function generateHtml($link) {
$link = "http://www.smalldevelopers.co.ke";
...
<body>
    ...
    <tr>
      <td class="m_w320 m_pt0" width="580" align="center" style="padding-top:20px">
        <table class="m_w320 m_b0" height="40" width="580" align="center" border="0" cellpadding="0" cellspacing="0" style="background-color:#ffffff">
          <tr>
            <td class="m_w280 m_pl20 m_pr20 m_pt20" width="580" align="left" style="padding:30px 30px 20px 30px">
              <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td class="m_h40" align="left" valign="bottom" height="50">
                    <a href="http://worldofreports.com"
                      title="Visit World Of Reports">
                      <img class="m_wh40" width="150" height="80" border="0" src="http://smalltechnologies.co.ke/wr/logo_dark.png" style="-ms-interpolation-mode:bicubic;text-decoration:none;display:block;outline:none;" />
                    </a>
                  </td>
                </tr>
              </table>
              ...
              <table width="100%" border="0" cellpadding="0" cellspacing="0" style="background-color:#ffffff">
                      ...
                      <tr>
                        <td class="m_pb25" align="left" valign="bottom" style="padding:0 0 35px 0">
                          <table class="m_w280" width="400">
                            <tr>
                              <td class="m_overflow280 " style="font-size:32px; line-height:36px;padding:0 0 0 0;font-family:helvetica neue,helvetica,arial,sans-serif;font-weight:bold;color:#444444;max-width:510px;overflow:hidden;text-overflow:ellipsis">Before we <span style="color:#269AF2;">get started...</span>
                ...
                <tr>
                  <td class="m_w280 m_pl20 m_pr20" width="580" align="center" style="padding:0 30px 0 30px;background-color:#ffffff">
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
                      <tr>
                        <td class="m_h3 " align="left" valign="bottom" style="padding:0 0 40px 0;font-family:helvetica neue,helvetica,arial,sans-serif;font-size:22px;line-height:26px;color:#444444">Please take a second to make sure we’ve got your email right.</td>
                      </tr>
                    </table>
                  </td>
                </tr>
                      ...
                      <tr>
                        <td class="m_plr0" align="center" style="padding:0 35px 0 35px">
                          <a href="'.$link.'"
                            ...
                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                              <tr>
                                <td align="center" style="padding:14px 20px 14px 20px;background-color:#269AF2;border-radius:4px">
    ...
    <tr>
      <td align="center">
        <table class="m_w320" width="580" align="center" border="0" cellpadding="0" cellspacing="0" style="background-color:#f7f7f7">
          <tr>
            <td class="m_w280 m_pl20 m_pr20" align="center" style="padding:0 30px 90px 30px">
              <table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
                <tr>
                  <td align="left" valign="bottom" height="30" style="padding:30px 0 30px 0">
                    <img width="65" height="35" border="0" alt="Pinterest" src="http://smalltechnologies.co.ke/wr/logo_dark.png" style="-ms-interpolation-mode:bicubic;text-decoration:none;display:block;outline:none;" />
                  </td>
                </tr>
                <tr>
                  <td align="left" valign="bottom" style="font-family:helvetica neue,helvetica,arial,sans-serif;font-size:24px;line-height:28px;font-weight:bold;color:#a7a7a7">Get the report that you need</td>
                </tr>
              </table>
            </td>
          </tr>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
                      <tr>
                        <td align="left" style="font-family:helvetica neue,helvetica,arial,sans-serif;font-size:12px;line-height:22px;color:#444444">
                          <a href="#" style="color:#444444;text-decoration:none;pointer-events:none;">Nairobi</a>
                        </td>
                        <td align="left" style="padding:0 4px 0 4px;font-family:sans-serif;font-size:18px;color:#444444">&middot;</td>
                        <td align="left" style="font-family:helvetica neue,helvetica,arial,sans-serif;font-size:12px;line-height:22px;color:#444444">
                          <a href="#" style="color:#444444;text-decoration:none;pointer-events:none;">Kenya, 94103</a>
                        </td>
                      </tr>
                    </table>
                    <table border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
                      <tr>
                        <td align="left" style="font-family:helvetica neue,helvetica,arial,sans-serif;font-size:12px;line-height:22px;color:#444444">
                          <a href="#"
                            style="color:#444444;text-decoration:underline;" title="Find answers in our Help Center">Help Center</a>
                        </td>
                        <td align="left" style="padding:0 4px 0 4px;font-family:sans-serif;font-size:18px;color:#444444">&middot;</td>
                        <td align="left" style="font-family:helvetica neue,helvetica,arial,sans-serif;font-size:12px;line-height:22px;color:#444444">
                          <a href="#"
                            style="color:#444444;text-decoration:underline">Privacy Policy</a>
                        </td>
                        <td align="left" style="padding:0 4px 0 4px;font-family:sans-serif;font-size:18px;color:#444444">&middot;</td>
                        <td align="left" style="font-family:helvetica neue,helvetica,arial,sans-serif;font-size:12px;line-height:22px;color:#444444">
                          <a href="#"
                            style="color:#444444;text-decoration:underline">Terms & Conditions</a>
                        </td>
                      </tr>
                    </table>
                    <table border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
                      <tr>
                        <td align="left" style="font-family:helvetica neue,helvetica,arial,sans-serif;font-size:12px;line-height:22px;color:#444444">
                          <a href="#"
                            style="color:#444444;text-decoration:underline;" title="Unsubscribe from this email">Unsubscribe from this email</a>
                        </td>
                      </tr>
                    </table>
                  </td>
  ...
  <img src="https://www.pinterest.com/email/tracking.gif?e_t=921b5cab6a7c4d60930c155a3c7b360e" width="0" height="0" />
